...
function ocm_comp_format_individual_get_format( $html, $id ) {
    ...
    $html .= "value=" . OCM_CFMT_INDIVIDUAL . ">" . __('Individual', TEXT_DOMAIN) . "</option>\n";
...
function ocm_comp_format_individual_display_format( $html, $compid ) {
    ...
    if ( get_post_meta( $compid, '_formatid', true) == OCM_CFMT_INDIVIDUAL ) {
        $html .= sprintf("%s [%s]", __('Individual', TEXT_DOMAIN), get_post_meta( $compid , '_size' , true )); 
    }
...
function ocm_comp_format_individual_display_format_fields( $html, $compid ) {
    ...
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Number of rounds', TEXT_DOMAIN) . "</label></td>";
    if ($formatok == 'false') {
    ...
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Round score separator', TEXT_DOMAIN) . "</label></td>";
    $html .= "<td><input id='_separator' type='text' name='_separator' value='$separator' /></td>\n";        
    $html .= "</tr>\n";

    $score_systems = array( __('None', TEXT_DOMAIN),
                            __('Sum', TEXT_DOMAIN)
                          );    
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Scoring System', TEXT_DOMAIN) . " - " . __('Match', TEXT_DOMAIN) . "</label></td>\n";        
    ...
    $score_systems_matches = array( __('None', TEXT_DOMAIN),
									__('Sum', TEXT_DOMAIN),
									__('Average Sum', TEXT_DOMAIN)
								  );
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Scoring System', TEXT_DOMAIN) . " - " . __('Matches', TEXT_DOMAIN) . "</label></td>\n";        
    ...
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Scoring System', TEXT_DOMAIN) . " - " . __('Matches', TEXT_DOMAIN) . " - " . __('Use best #', TEXT_DOMAIN) . "</label></td>\n";
    ...
    $orders = array( __('More is better', TEXT_DOMAIN),
					 __('Less is better', TEXT_DOMAIN),
				   );
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Scoring System', TEXT_DOMAIN) . " - " . __('Order', TEXT_DOMAIN) . "</label></td>\n";        
...
function ocm_comp_format_individual_display_ranking( $html, $compid, $display_all, $display_header ) {
    ...
    if ( $display_header == true ) {
		if ( is_admin() ) {
			$html .= "<tr><th>"
					.join( "</th><th>", array( "", __('Played', TEXT_DOMAIN), __('Points', TEXT_DOMAIN)) )
					."</th></tr>\n";
		} else {
			...
			$html .= "<div id=\"scm_ranking_played\" class=\"header individual\">" . __('Played', TEXT_DOMAIN) . "</div>\n";
			$html .= "<div id=\"scm_ranking_points\" class=\"header individual\">" . __('Points', TEXT_DOMAIN) . "</div>\n";
			$html .= "</div>\n";	 
			$html .= "</div>\n"; 
		}
    }
