...
function ocm_teamplayer_custom_post_init(){
    ...
    $labels = array(
        'name' => __('Team Players', TEXT_DOMAIN),
        'singular_name' => __('Team Player', TEXT_DOMAIN),
        'add_new' => __('Add New Team Player', TEXT_DOMAIN),
        'add_new_item' => __('Add New Team Player', TEXT_DOMAIN),
        'edit_item' => __('Edit Team Player', TEXT_DOMAIN),
        'new_item' => __('New Team Player', TEXT_DOMAIN),
        'view_item' => __('View Team Player', TEXT_DOMAIN),
        'search_items' => __('Search Team Players', TEXT_DOMAIN),
        'not_found' => __('No Team Players found', TEXT_DOMAIN),
        'not_found_in_trash' => __('No Team Players found in Trash', TEXT_DOMAIN),
        'parent_item_colon' => __('Parent Team Player:', TEXT_DOMAIN),
        'menu_name' => __('Team Players', TEXT_DOMAIN),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => false,
...
function ocm_teamplayer_add_fields_box() {
    ...
    add_meta_box('ocm_teamplayer_fields_box_id', __('Team Player Data', TEXT_DOMAIN), 'ocm_teamplayer_display_fields', 'ocm_teamplayer');
	if ($pagenow == 'post-new.php') {
		add_meta_box('ocm_teamplayer_bulk_box_id', __('Add team players for members in selected category', TEXT_DOMAIN), 'ocm_teamplayer_bulk', 'ocm_teamplayer');
	}
    if ($pagenow == 'post.php') {
		add_meta_box('ocm_teamplayer_list_box_id', __('Team Players', TEXT_DOMAIN), 'ocm_teamplayer_display_list', 'ocm_teamplayer');
	}
}
function ocm_teamplayer_display_fields() {
    ...
    $team_options = "<option value=''> ".__('none', TEXT_DOMAIN)." </option>\n";
    ...
    $html = "
        ...
        <tr>
        <td align='right'><label>".__('Team', TEXT_DOMAIN)."</label></td>
...
function ocm_teamplayer_columns($defaults) {  
    ...
    $defaults['team']  = __('Team', TEXT_DOMAIN);
