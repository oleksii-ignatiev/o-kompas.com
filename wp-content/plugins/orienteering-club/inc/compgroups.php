...
function ocm_comp_group_custom_post_init(){
    ...
    $labels = array(
        'name' => __('Competition Group Categories', TEXT_DOMAIN),
        'singular_name' => __('Competition Group Category', TEXT_DOMAIN),
        'search_items' => __('Search Competition Group Categories', TEXT_DOMAIN),
        'all_items' => __('All Competition Group Categories', TEXT_DOMAIN),
        'parent_item' => __('Parent Competition Group Category', TEXT_DOMAIN),
        'parent_item_colon' => __('Parent Competition Group Category:', TEXT_DOMAIN),
        'edit_item' => __('Edit Competition Group Category', TEXT_DOMAIN), 
        'update_item' => __('Update Competition Group Category', TEXT_DOMAIN),
        'add_new_item' => __('Add New Competition Group Category', TEXT_DOMAIN),
        'new_item_name' => __('New Competition Group Category', TEXT_DOMAIN),
        'menu_name' => __('Competition Group Categories', TEXT_DOMAIN),
    ); 	
    ...
    $labels = array(
        'name' => __('Competition Groups', TEXT_DOMAIN),
        'singular_name' => __('Competition Group', TEXT_DOMAIN),
        'add_new' => __('Add New Competition Group', TEXT_DOMAIN),
        'add_new_item' => __('Add New Competition Group', TEXT_DOMAIN),
        'edit_item' => __('Edit Competition Group', TEXT_DOMAIN),
        'new_item' => __('New Competition Group', TEXT_DOMAIN),
        'view_item' => __('View Competition Group', TEXT_DOMAIN),
        'search_items' => __('Search Competition Groups', TEXT_DOMAIN),
        'not_found' => __('No Competition Groups found', TEXT_DOMAIN),
        'not_found_in_trash' => __('No Competition Groups found in Trash', TEXT_DOMAIN),
        'parent_item_colon' => __('Parent Competition Group:', TEXT_DOMAIN),
        'menu_name' => __('Competition Groups', TEXT_DOMAIN),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => false,
...
function ocm_comp_group_add_fields_box() {
    ...
    add_meta_box('ocm_comp_group_fields_box_id', __('Competition Group Data', TEXT_DOMAIN), 'ocm_comp_group_display_fields', 'ocm_comp_group');
    if ($pagenow == 'post.php') {
		add_meta_box('ocm_comp_group_ranking_id', __('Ranking', TEXT_DOMAIN), 'ocm_comp_group_display_ranking', 'ocm_comp_group');
		add_meta_box('ocm_comp_group_list_id', __('Competitions', TEXT_DOMAIN), 'ocm_comp_group_display_list', 'ocm_comp_group');
        add_meta_box('ocm_comp_group_shortcodes_box_id', __('Shortcodes', TEXT_DOMAIN), 'ocm_comp_group_list_shortcodes', 'ocm_comp_group', 'side', 'high');
	}
}
function ocm_comp_group_display_fields() {
    ...
    $format = isset($values['_format']) ? esc_attr($values['_format'][0]) : __('none', TEXT_DOMAIN);
    ...
    $html = "
        <tr>
        <td align='right'><label>".__('Group Format', TEXT_DOMAIN)."</label></td>\n
...
function ocm_comp_group_columns($defaults) {  
    ...
    // new column titles
    $defaults['format'] = __('Group Format', TEXT_DOMAIN);
