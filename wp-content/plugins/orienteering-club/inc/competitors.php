...
function ocm_competitor_custom_post_init(){
    ...
    $labels = array(
        'name' => __('Competitors', TEXT_DOMAIN),
        'singular_name' => __('Competitor', TEXT_DOMAIN),
        'add_new' => __('Add New Competitor', TEXT_DOMAIN),
        'add_new_item' => __('Add New Competitor', TEXT_DOMAIN),
        'edit_item' => __('Edit Competitor', TEXT_DOMAIN),
        'new_item' => __('New Competitor', TEXT_DOMAIN),
        'view_item' => __('View Competitor', TEXT_DOMAIN),
        'search_items' => __('Search Competitors', TEXT_DOMAIN),
        'not_found' => __('No Competitors found', TEXT_DOMAIN),
        'not_found_in_trash' => __('No Competitors found in Trash', TEXT_DOMAIN),
        'parent_item_colon' => __('Parent Competitor:', TEXT_DOMAIN),
        'menu_name' => __('Competitors', TEXT_DOMAIN),
    );
    $args = array(
        'labels' => $labels,
        'hierarchical' => false,
...
function ocm_competitor_add_fields_box() {
    ...
    add_meta_box('ocm_competitor_fields_box_id', __('Competitor Data', TEXT_DOMAIN), 'ocm_competitor_display_fields', 'ocm_competitor');
	if ($pagenow == 'post-new.php') {
		add_meta_box('ocm_competitor_bulk_box_id', __('Add competitors for members in selected category', TEXT_DOMAIN), 'ocm_competitor_bulk', 'ocm_competitor');
	}
    if ($pagenow == 'post.php') {
		add_meta_box('ocm_teamplayer_list_box_id', __('Team Players', TEXT_DOMAIN), 'ocm_competitor_display_team', 'ocm_competitor');
        add_meta_box('ocm_competitor_shortcodes_box_id', __('Shortcodes', TEXT_DOMAIN), 'ocm_competitor_list_shortcodes', 'ocm_competitor', 'side', 'high');
	}
}
...
function ocm_competitor_register_rest_fields(){
	...
	register_rest_field( 'ocm_competitor', 'competitor_type', array( /*'get_callback' => 'ocm_member_get_first_name' 
																   , */'update_callback' => 'ocm_competitor_update' 
																   , 'schema' => array( 'description' => __('Competitor type', TEXT_DOMAIN) , 'type' => 'string', 'required' => 'true' )) ); 
