...
if ( ! class_exists( 'OSM_Post_Types_Events' ) ) {

	class OSM_Post_Types_Events {

		function __construct(){
			add_action( 'init', array( __CLASS__, 'register_post_types' ) );
			add_filter( 'single_template', array( __CLASS__, 'load_event_template' ) );
				...
				register_post_type(
					...
					array(
						'labels'       => array(
							...
							'singular_name'         => _x( 'Event', 'Site post type singular name', TEXT_DOMAIN ),
							'add_new'               => __( 'Add Event', TEXT_DOMAIN ),
							'add_new_item'          => __( 'Add New Event', TEXT_DOMAIN ),
							'edit'                  => __( 'Edit', TEXT_DOMAIN ),
							'edit_item'             => __( 'Edit Event', TEXT_DOMAIN ),
							'new_item'              => __( 'New Event', TEXT_DOMAIN ),
							'view'                  => __( 'View Events', TEXT_DOMAIN ),
							'view_item'             => __( 'View Event', TEXT_DOMAIN ),
							'search_items'          => __( 'Search Events', TEXT_DOMAIN ),
							'not_found'             => __( 'No Events found', TEXT_DOMAIN ),
							'not_found_in_trash'    => __( 'No Events found in trash', TEXT_DOMAIN ),
							'parent'                => __( 'Parent Event', TEXT_DOMAIN ),
							'menu_name'             => _x( 'Events', 'Admin menu name', TEXT_DOMAIN ),
							'filter_items_list'     => __( 'Filter Events', TEXT_DOMAIN ),
							'items_list_navigation' => __( 'Event navigation', TEXT_DOMAIN ),
		...
		public static function load_event_template( $template ) {
			global $post;

			if ( 'events' === $post->post_type && locate_template( array( 'single-events.php' ) ) !== $template ) {
				
				return OCM_DIR . TEMPLATES . 'single-events.php';
			}
