...
if ( ! class_exists( 'OSM_Post_Types_Clubs' ) ) {

	class OSM_Post_Types_Clubs {
		...
		public static function register_post_types() {
			...
			if ( !post_type_exists( 'clubs' ) ) {
				register_post_type(
					'clubs',
					array(
						'labels'       => array(
							'name'                  => __( 'Clubs', TEXT_DOMAIN ),
							'singular_name'         => _x( 'Club', 'Site post type singular name', TEXT_DOMAIN ),
							'add_new'               => __( 'Add Club', TEXT_DOMAIN ),
							'add_new_item'          => __( 'Add New Club', TEXT_DOMAIN ),
							'edit'                  => __( 'Edit', TEXT_DOMAIN ),
							'edit_item'             => __( 'Edit Club', TEXT_DOMAIN ),
							'new_item'              => __( 'New Club', TEXT_DOMAIN ),
							'view'                  => __( 'View Clubs', TEXT_DOMAIN ),
							'view_item'             => __( 'View Club', TEXT_DOMAIN ),
							'search_items'          => __( 'Search Clubs', TEXT_DOMAIN ),
							'not_found'             => __( 'No Clubs found', TEXT_DOMAIN ),
							'not_found_in_trash'    => __( 'No Clubs found in trash', TEXT_DOMAIN ),
							'parent'                => __( 'Parent Club', TEXT_DOMAIN ),
							'menu_name'             => _x( 'Clubs', 'Admin menu name', TEXT_DOMAIN ),
							'filter_items_list'     => __( 'Filter Clubs', TEXT_DOMAIN ),
							'items_list_navigation' => __( 'Club navigation', TEXT_DOMAIN ),
							'items_list'            => __( 'Club list', TEXT_DOMAIN ),
						),
						// 'menu_position'         => 6,
