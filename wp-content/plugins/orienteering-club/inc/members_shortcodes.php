...
function ocm_sh_member_data( $atts ) {
    ...
    if ( $show_partial ) {
		...
		$html .= " <div id=\"scm_member_field\">" . __('Phone', TEXT_DOMAIN) . "</div>";
		$html .= " <div id=\"scm_member_field_content\">" . sprintf("%s %s", $phone, $cell) . "</div>";
	    $html .= "</div> \n";
        $html .= "<div id=\"scm_member_data\"> \n";
		$html .= " <div id=\"scm_member_field\">" . __('E-mail', TEXT_DOMAIN) . "</div>";
		$html .= " <div id=\"scm_member_field_content\">" . $email . "</div>";
	    $html .= "</div> \n";
    }
	$html .= "<div id=\"scm_member_data\"> \n";
	$html .= " <div id=\"scm_member_field\">" . __('Date of birth', TEXT_DOMAIN) . "</div>";
	$html .= " <div id=\"scm_member_field_content\">" . $dateofbirth . "</div>";
	$html .= "</div> \n";
	if ($level != "") {
		$html .= "<div id=\"scm_member_data\"> \n";
		$html .= " <div id=\"scm_member_field\">" . __('Level', TEXT_DOMAIN) . "</div>";
	...
	$html .= "<div id=\"scm_member_data\"> \n";
	$html .= " <div id=\"scm_member_field\">" . __('Start date membership', TEXT_DOMAIN) . "</div>";
	$html .= " <div id=\"scm_member_field_content\">" . $startdate . "</div>";
	$html .= "</div> \n";
	if (($enddate != "") && ($enddate != "0000-00-00")) {
		$html .= "<div id=\"scm_member_data\"> \n";
		$html .= " <div id=\"scm_member_field\">" . __('End date membership', TEXT_DOMAIN) . "</div>";
