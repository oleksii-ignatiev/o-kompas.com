...
function ocm_comp_format_league_get_format( $html, $id ) {
    ...
    $html .= "value=" . OCM_CFMT_LEAGUE . ">" . __('League', 'o-kompas') . "</option>\n";
...
function ocm_comp_format_league_display_format_fields( $html, $compid ) {
    ...
    $score_systems = array( __('Points Won', 'o-kompas'),
                            __('Win-Draw-Loss = 3-1-0', 'o-kompas'),
                            __('Win-Draw-Loss = 2-1-0', 'o-kompas')
                          );
    
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>" . __('Scoring System', 'o-kompas') . "</label></td>\n";
...
function ocm_comp_format_league_display_ranking( $html, $compid, $display_all, $display_header ) {
    ...
    if ( $display_header == true ) {
		if ( is_admin() ) {
			$html .= "<tr><th>"
					.join( "</th><th>", array( "", __('Played', 'o-kompas'), __('Points', 'o-kompas'), __('W - D - L', 'o-kompas'), __('Diff', 'o-kompas')) )
					."</th></tr>\n";
		} else {
			...
			$html .= "<div id=\"scm_ranking_played\" class=\"header league\">" . __('Played', 'o-kompas') . "</div>\n";
			$html .= "<div id=\"scm_ranking_points\" class=\"header league\">" . __('Points', 'o-kompas') . "</div>\n";
			$html .= "<div id=\"scm_ranking_wondrawlost\" class=\"header league\">" . __('W - D - L', 'o-kompas') . "</div>\n";
			$html .= "<div id=\"scm_ranking_diff\" class=\"header league\">" . __('Diff', 'o-kompas') . "</div>\n";
			$html .= "</div>\n";	 
			$html .= "</div>\n"; 
		}
    }
...
function ocm_comp_format_league_display_competitor_format_fields( $html, $competitor_id, $competition_id ) {
    ...
    $html .= "<tr>\n";
    $html .= "<td align='right'><label>".__('Disable Ranking', 'o-kompas')."</label></td>";
