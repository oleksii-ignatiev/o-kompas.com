...
class ocm_member_widget_birthdays extends WP_Widget {
    ...
    public function __construct() {
        ...
        parent::__construct(
            ...
            __( 'Sports Club', 'o-kompas' ) . " - " . __( 'Birthdays', 'o-kompas' ),
            array(
                'classname'   => 'ocm_member_widget_birthdays',
                'description' => __( 'List of member\'s birthdays', 'o-kompas' )
                )
        );
    }
    ...
    public function form( $instance ) {    
        ...
        <p>
            <label for="<?php echo $this->get_field_id('start'); ?>"><?php echo __('Number of days before today', 'o-kompas'); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id('end'); ?>"><?php echo __('Number of days after today', 'o-kompas'); ?></label> 
        ...
        <p>
            <label for="<?php echo $this->get_field_id('emptylist'); ?>"><?php echo __('Text for empty list', 'o-kompas'); ?></label> 
        ...
        <p>
            ...
            <label for="<?php echo $this->get_field_id('needlogin'); ?>"><?php echo __('Visible after login only', 'o-kompas'); ?></label> 
        </p>
