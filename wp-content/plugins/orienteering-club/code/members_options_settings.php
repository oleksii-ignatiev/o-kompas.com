...
?>
<div class="updated">
    <p><strong><?php _e('Member options saved.', 'o-kompas'); ?></strong></p>
</div>
<?php 
...
<form name="ocm_member_option_form" method="post" action="<?php echo admin_url('admin.php').'?page='.$_GET['page']; ?>">
    <div class="metabox-holder ">
        <div class="postbox"> 
            <h3><?php _e('Member Options', 'o-kompas') ?></h3>
        </div>
    </div>
    <table class="form-table">
        <tr>
            <th scope="row"><?php _e('Privacy', 'o-kompas') ?></th>
            <td> 
            ...
            <?php _e('Display privacy related data of other members', 'o-kompas') ?></label>
            </fieldset>
            ...
            <?php _e('Display address, e-mail, and phone numbers of other members', 'o-kompas') ?></label>
            </fieldset>
			</td>
        </tr>
        <tr>
            <th scope="row"><label for="custom_member"><?php _e('Custom values', 'o-kompas') ?></label></th>
            <td>
            <input name="ocm_custom1_member" type="text" value="<?php echo $custom1_member; ?>" class="regular-text" />
            <p class="description"><?php _e('Name for custom value #1', 'o-kompas') ?></p>
            <input name="ocm_custom2_member" type="text" value="<?php echo $custom2_member; ?>" class="regular-text" />
            <p class="description"><?php _e('Name for custom value #2', 'o-kompas') ?></p>
            <input name="ocm_custom3_member" type="text" value="<?php echo $custom3_member; ?>" class="regular-text" />
            <p class="description"><?php _e('Name for custom value #3', 'o-kompas') ?></p>
            <input name="ocm_custom4_member" type="text" value="<?php echo $custom4_member; ?>" class="regular-text" />
            <p class="description"><?php _e('Name for custom value #4', 'o-kompas') ?></p>
            </td>
        </tr>
<?php
...
?>        
    ...
    <input type="submit" name="submit_member_option" class="button-primary" value="<?php _e('Save Member Options', 'o-kompas') ?>" />
