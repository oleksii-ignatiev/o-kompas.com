...
?>
<div class="updated">
    <p><strong><?php _e('Invoice options saved.', 'o-kompas'); ?></strong></p>
</div>          
<?php 
...
<form name="ocm_invoice_option_form" method="post" action="<?php echo admin_url('admin.php').'?page='.$_GET['page']; ?>">
    <div class="metabox-holder ">
        <div class="postbox"> 
            <h3><?php _e('Invoice Options', 'o-kompas') ?></h3>
        </div>
    </div>
    <table class="form-table">
        <tr>
            <th scope="row"><?php _e('Include invoices', 'o-kompas') ?></th>
            ...
            <?php _e('Granted', 'o-kompas') ?></label>
            </fieldset></td>
        </tr>
        <tr>
            <th scope="row"><label for="custom_invoice"><?php _e('Custom values', 'o-kompas') ?></label></th>
            <td>
...
?>        
    ...
    <input type="submit" name="submit_invoice_option" class="button-primary" value="<?php _e('Save Invoice Options', 'o-kompas') ?>" />
